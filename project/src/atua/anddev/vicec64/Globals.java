...
class Globals
{
	...
	public static String ApplicationName = "ViceC64";
	public static String AppLibraries[] = { "sdl_native_helpers", "sdl-1.2", "intl", "zzip", "sdl_image", "sdl_ttf", "guichan" };
	public static String AppMainLibraries[] = {  "application", "sdl_main" };
	public static final boolean Using_SDL_1_3 = false;
	public static final boolean Using_SDL_2_0 = false;
	public static String[] DataDownloadUrl = { "!!Vice data size is 180 Kb|vice-data.zip", "!!C64 data size is 30 Kb|C64.ZIP", "!!config file 1 Kb|config2-c64.zip", "!!gui files|guichan2.zip",  };
	...
	public static int TextInputKeyboard = 2;
	...
	public static String DeleteFilesOnUpgrade = ".vice/sdl-vicerc";
	public static int AppTouchscreenKeyboardKeysAmount = 3;
	public static String[] AppTouchscreenKeyboardKeysNames = "F14 ESCAPE SPACE F1 F3 F5 F7".split(" ");
	public static int StartupMenuButtonTimeout = 2000;
	public static int AppMinimumRAM = 256;
	public static SettingsMenu.Menu HiddenMenuOptions [] = {  new SettingsMenuMisc.OptionalDownloadConfig(), new SettingsMenuMouse.DisplaySizeConfig(), }; // If you see error here - update HiddenMenuOptions in your AndroidAppSettings.cfg: change OptionalDownloadConfig to SettingsMenuMisc.OptionalDownloadConfig etc.
	...
	public static int TouchscreenKeyboardTheme = 9;
	public static int TouchscreenKeyboardTransparency = 2;
	public static boolean FloatingScreenJoystick = true;
